...
public class StepDefHotelBooking {
	...
	public HotelBookingPageFactory objhbpg;
...
public void user_is_on_hotel_booking_page() throws Throwable {
	...
	//driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
	//objhbpg = new HotelBookingPageFactory(driver);
	driver.get("file:///D:/Selenium_training%20projects/hotelbooking.html");
...
public void navigate_to_welcome_page() throws Throwable {
	driver.navigate().to("file:///D:/capgemini%20docs/selenium_cap_code/hotel_booking_solution/hotelBookingSolution/hotelBooking/success.html");
